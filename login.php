...
if (isset($_POST['btnLogin'])) {
    ...
    $result = mysqli_query($con, "SELECT * FROM saksi WHERE nama = '$nama'");

    // cek email
    if (mysqli_num_rows($result) > 0) {
        $row = mysqli_fetch_assoc($result);
        if ($password == $row['password']) {
            $_SESSION['saksi'] = $row['nama'];
            $_SESSION['id_saksi'] = $row['id_saksi'];
                    ...
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <form action="" method="post">
                            <div class="row px-3">
                                ...
                                <input class="mb-4" type="text" name="nama" placeholder="Masukkan Nama">
                            </div>
                            <div class="row px-3">
                                <label class="mb-1">
